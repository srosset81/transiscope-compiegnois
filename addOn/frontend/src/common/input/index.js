...
export const ActorsInput = ({ source, ...props }) => (
  <ReferenceArrayInput reference="Actor" source={source} enableGetChoices={ifTwoLetters}>
...
export const ThemesInput = ({ source, ...props }) => (
  <ReferenceArrayInput reference="Theme" source={source} enableGetChoices={ifTwoLetters}>
