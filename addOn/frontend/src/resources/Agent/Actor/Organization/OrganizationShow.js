...
const ConditionalSourceDefinedHandler = ({
  ...
  if (
    record?.[source] &&
    (!Array.isArray(record[source]) || record[source].length > 0)
  ) {
        ...
        <Grid item xs={12} sm={9}>
          ...
          <MainList>
            ...
            <MapField
              ...
              latitude={(record) =>
                record["pair:hasLocation"] &&
                record["pair:hasLocation"]["pair:latitude"]
              }
              longitude={(record) =>
                record["pair:hasLocation"] &&
                record["pair:hasLocation"]["pair:longitude"]
              }
            />
          </MainList>
        </Grid>
